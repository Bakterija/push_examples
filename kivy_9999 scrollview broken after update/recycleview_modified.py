...
from scrollview22 import ScrollView_Modified as ScrollView
...
class RecycleView_Modified(RecycleViewBehavior, ScrollView):
    """
    ...
    def __init__(self, **kwargs):
        ...
        super(RecycleView_Modified, self).__init__(**kwargs)
    ...
    def add_widget(self, widget, *largs):
        super(RecycleView_Modified, self).add_widget(widget, *largs)
    ...
    def remove_widget(self, widget, *largs):
        super(RecycleView_Modified, self).remove_widget(widget, *largs)
